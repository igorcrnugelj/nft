...
import { editLayer, getLayers } from "../../store/actions/Layer";
...
const EditLayerForm = () => {
  ...
  const layerNameChangeHandler = (event) => {
    setLayerName(event.target.value);
  };
  const layerDescriptionChangeHandler = (event) => {
    setLayerDescription(event.target.value);
  };
  const layerRarityChangeHandler = (event) => {
